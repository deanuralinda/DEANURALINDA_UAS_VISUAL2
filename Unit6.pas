...
if edt3.Text ='' then
begin
ShowMessage('PASSWORD BOLEH KOSONG!');
end else
if edt4.Text ='' then
begin
ShowMessage('LEVEL HUBUNGAN TIDAK BOLEH KOSONG!');
end else
if edt5.Text ='' then
begin
...
zqry1.SQL.Add('insert into tabel_user values("'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'","'+edt4.Text+'","'+edt5.Text+'")');
zqry1.ExecSQL ;
...
begin
  ...
  begin
    id_user := zqry1.FieldByName('id_user').AsString;
    if edt1.Text = id_user then
    begin
      zqry1.Edit;
...
begin
  ...
  begin
    zqry1.SQL.Clear;
    zqry1.SQL.Add('DELETE FROM tabel_user WHERE id_user = "' + id_user + '"');
    zqry1.ExecSQL;
    zqry1.SQL.Clear;
    zqry1.SQL.Add('SELECT * FROM tabel_user');
    zqry1.Open;
